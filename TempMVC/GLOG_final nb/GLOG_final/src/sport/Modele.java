...
public class Modele {
    ...
    public Modele (String User , String MP ){
        
        administrateur = new Admin(0, User , MP, User );
        
    }
    
    boolean Init_APP( Admin a ){
        
        // si il arrive pas a ce connécter a la base de donnée , il renvoi false
        
        Init_Clients(a);
        //Init_coachs(a);
        //...... et init toutes les classe 
    ...
    // répéter pour toutes les listes 
    public void Init_Clients(Admin a) 
    {
        // charger tout les client de la base de donnée
        
        // créer une classe client remplire ces champs avec les infos de la base de données
    ...
    {
        // demander a la base de donné d'actualiser la liste avec Init_clients
    ...
    /*
	public static void Modele(String[] args) {
